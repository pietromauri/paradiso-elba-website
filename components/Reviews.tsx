            ...
            {[...Array(5)].map((_, index) => {
                ...
                return (
                    <button
                        ...
                        className="focus:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 focus-visible:ring-offset-2 rounded-full p-1 transition-shadow"
                        aria-label={`Valuta ${starValue} ${starValue === 1 ? 'stella' : 'stelle'}`}
                    >
                        <svg aria-hidden="true" className={`w-8 h-8 transition-colors ${starValue <= (hoverRating || rating) ? 'text-yellow-400' : 'text-gray-300'}`} fill="currentColor" viewBox="0 0 20 20">
